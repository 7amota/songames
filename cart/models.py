...
class Cart(models.Model):
    user = models.OneToOneField(User, on_delete=models.PROTECT,related_name='cart_user')
...
class CartItem(models.Model):
    ...
    game = models.ForeignKey(Game,on_delete=models.PROTECT,related_name='caaart')
