...
class CartItem(models.Model):
    game = models.ForeignKey(Game,on_delete=models.CASCADE,related_name='cart_item_game')
    quantity = models.IntegerField(null=True, blank=True, default=1)
    cart = models.ForeignKey(Cart, on_delete=models.PROTECT,related_name="cart_item_cart")
