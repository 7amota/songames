...
class Character(models.Model):
    ...
    image = models.ImageField(upload_to="photos/character/%y/%m/%d",validators=[FileExtensionValidator(['webp','png','jpg','avif','jpeg'])])
...
class Game(TimeStampedModel):
    ...
    logo = models.ImageField(upload_to='Photos/logo/%y/%m/%d', validators=[FileExtensionValidator(['webp','png','jpg','avif','jpeg'])])
    banner = models.ImageField(upload_to='Photos/banner/%y/%m/%d',validators=[FileExtensionValidator(['webp','png','jpg','avif','jpeg'])])
    popular = models.BooleanField(null=True, blank=True)
    bannerLogo = models.ImageField(upload_to='Photos/bannerLogo/%y/%m/%d',validators=[FileExtensionValidator(['webp','png','jpg','avif','jpeg'])])
